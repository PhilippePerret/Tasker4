      ...
      delai_realisation = 
        cond do
          should_start && should_end -> 
            should_start = if is_binary(should_start) and (String.length(should_start) == String.length("2025-10-10T10:00")) do
              should_start <> ":00"
            else
              should_start
            end
            should_end = if is_binary(should_end) and (String.length(should_end) == String.length("2025-10-10T10:00")) do
              should_end <> ":00"
            else
              should_end
            end
