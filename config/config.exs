...
config :tasker, TaskerWeb.Endpoint,
  ...
  live_view: [signing_salt: "VBRE4Gnq"]
...
config :esbuild,
  ...
  tasker: [
    args:
      ~w(js/app.js js/task_edition.js css/app.css js/atwork.js css/atwork.css --bundle --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
